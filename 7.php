...
<html>
    ...
    <head>
        <title>Processador Intel Core i5-8400 Coffee Lake - Rexpeita</title>
    </head>
                ...
                <div class="card-body">
                    <div class="col-sm">
                        <h3 class="card-title">Descrição do Produto</h3>
                            ...
                            - Nº de threads: 6
                            <br>
                            - Frequência baseada em processador: 2,80 GHz
                            <br>
                            - Frequência turbo max: 4,00 GHz
                            <br>
                            - Cache: 9 MB
                            <br>
                            ...
                            <br>
                            - Processador Intel i5-8400 Coffee Lake 8a Geração
                            <br>
                            - Cooler
                            <br>
                            ...
                            <strong>Peso:</strong>
                            <br>
                            275 gramas (bruto com embalagem)
                        </p>
                    </div>
                </div>
            </div>
