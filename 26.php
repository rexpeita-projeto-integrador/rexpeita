...
<html>
    ...
    <head>
        <title>Gabinete Hydra Desk Case em Aço Preto NR-01 - Rexpeita</title>
    </head>
                ...
                <div class="card-body">
                    <div class="col-sm">
                        <h3 class="card-title">Descrição do Produto</h3>
                            ...
                            <br>
                            - Tipo de Case: Desk case
                            <br>
                            - Dimensões (LxHxW): 1260 x 800 x 270 mm
                            <br>
                            - Cor: Preta
                            <br>
                            - Material da Estrutura: Aço (1.2mm)
                            <br>
                            - Suporte para placa-mãe até o E-ATX
                            <br>
                            - Material do painel transparente: vidro temperado (8mm)
                            <br>
                            - Compartimentos de unidades: baias de 4 x 5,25 ”(2 baias duplas e 2 baias individuais)
                            <br>
                            - Slots PCI-E: 4
                            <br>
                            - Suporte PSU: 1 PSU ATX de qualquer tamanho
                            <br>
                            - Suporte de Ventilador: Ventiladores de até 8 x 120 mm
                            <br>
                            - Suporte do Radiador: 2 x 480x55 mm 
                            <br>
                            - Suporte de armazenamento até 9 unidades de 3,5 "ou até 9 unidades de 2,5"
                            <br>
                            <strong>Conteúdo da Embalagem:</strong>
                            <br>
                            - Gabinete Hydra NR-01
                            <br>
