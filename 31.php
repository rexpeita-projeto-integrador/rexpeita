...
<html>
    ...
    <head>
        <title>Placa de Vídeo MSI NVIDIA GeForce RTX 2070 Ventus 8G, GDDR6 - Rexpeita</title>
    </head>
                ...
                <div class="card-body">
                    <div class="col-sm">
                        <h3 class="card-title">Descrição do Produto</h3>
                            ...
                            - Marca: MSI
                            <br>
                            - Modelo: GeForce RTX 2070 VENTUS 8G
                            <br>
                            ...
                            <br>
                            - Núcleos: 2304 unidades
                            <br>
                            - Núcleos do Clock: 1620 MHz
                            <br>
                            ...
                            <br>
                            - Consumo de Energia: 175W
                            <br>
                            - Entrada de energia: 8 pinos
                            <br>
                            <strong>Conteúdo da Embalagem:</strong>
                            <br>
                            - Placa de Vídeo MSI NVIDIA GeForce RTX 2070 Ventus
                            <br>
                            - Drive
                            <br>
                            - Guia do Usuário
                            ...
                            <strong>Peso:</strong>
                            <br>
                            1220 gramas (bruto com embalagem)
                        </p>
                    </div>
                </div>
            </div>
