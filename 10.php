...
<html>
    ...
    <head>
        <title>Processador AMD Ryzen 7 2700 Zen 1+ - Rexpeita</title>
    </head>
                ...
                <div class="card-body">
                    <div class="col-sm">
                        <h3 class="card-title">Descrição do Produto</h3>
                            ...
                            - Threads: 16
                            <br>
                            - Frequência de Operação: 3.2GHz (Max Turbo 4.1GHz)
                            <br>
                            - Cache L3: 16MB
                            <br>
                            - Cache L2: 4MB
                            ...
                            <strong>Peso:</strong>
                            <br>
                            635 gramas (bruto com embalagem)
                        </p>
                    </div>
                </div>
            </div>
