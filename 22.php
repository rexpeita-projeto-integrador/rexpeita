...
<html>
    ...
    <head>
        <title>Fonte PCYes 750W 80 Plus Bronze PFC Ativo - Rexpeita</title>
    </head>
                ...
                <div class="card-body">
                    <div class="col-sm">
                        <h3 class="card-title">Descrição do Produto</h3>
                            ...
                            - Padrão: ATX 12V
                            <br>
                            - Tensão: 127 ~ 220 V (Seleção Automática)
                            <br>
                            - Potência máxima: 750W
                            <br>
                            <strong>Cabos:</strong>
                            <br>
                            1x ATX 12V (20+4): 600mm
                            <br>
                            1x EPS 8 pinos 12V (4+4): 700mm
                            <br>
                            2x PCI-E 8 pinos (6+2): 600x100mm
                            <br>
                            2x SATAxSATAxSATA: 500x100x100mm
                            <br>
                            1x IDExIDExIDE: 500x100x100mm
                            <br>
                            1x IDExIDExFDD: 500x100x100mm
                            <br>
                            <strong>Conteúdo da Embalagem:</strong>
                            <br>
                            - Fonte PCYES 750W Plus Bronze
                            <br>
                            ...
                            <strong>Peso:</strong>
                            <br>
                            2110 gramas (bruto com embalagem)
                        </p>
                    </div>
                </div>
            </div>
