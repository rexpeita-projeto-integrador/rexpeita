...
<html>
    ...
    <head>
        <title>Memória Ram HyperX Fury, 4GB, 2400MHz - Rexpeita</title>
    </head>
                ...
                <div class="card-body">
                    <div class="col-sm">
                        <h3 class="card-title">Descrição do Produto</h3>
                            ...
                            <br>
                            - Velocidade de Frequência: 2.400MHz
                            <br>
                            - Latência CAS: CL15 (15-15-15)
                            <br>
                            - Tipo: DDR4
                            <br>
                            - Pinagem: 288-Pin
                            ...
                            <br>
                            - Temperatura de armazenagem: -55°C a 100°C
                            <br>
                            <strong>Conteúdo da Embalagem:</strong>
                            <br>
                            - Memória Kingston HyperX FURY
                            <br>
